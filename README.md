...
Also, I think it is important to say that according to the scientists from the Marine Journal: 11,416 sharks are killed worldwide every hour, that’s around 3 sharks per second. So maybe instead of being terrified by sharks, we should just try to stop hunting them. 
...
By exploring the age of the victims, it's easy to see that the youth is more affected by shark attacks, probably due to the presence of this age range in the ocean, or it may be that the elderly have more savings to bribe the ocean mafia.
...
<center>
<img src="./images/countries.png" alt="country" width="500"/>
</center>
...
To take a little perspective, there are about 30 million scuba dives around the world each week, that's 1.560 billion dives a year. According to the data, there have only been 127 shark attacks towards divers in the last 222 years. So attacks are really not common at all. 
...
For this hypothesis, I divided the countries in northern hemisphere and southern hemisphere, since the summer season takes place in different months. After doing this I created the next graph, with the number of attacks per season and per hemisphere, to show that indeed attacks are more likely to occur on the summer in any of the hemispheres. 

![summer](./images/season_2.png)
...
I believe data and information can help us change our perspective of things, and specially this data can help us find a way to coexist with this type of animals in a safer way, while knowing that they are not human-killing machines, but animals with really bad propaganda. 
...
Special thanks to **The Life of Sharks** for their ilustrations, and for the work they do in shark conservation. :shark:
